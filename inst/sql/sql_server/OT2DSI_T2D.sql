...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1502905)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21600712)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21600712)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (443732,201826,4008576)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (443732,201826)
  and c.invalid_reason is null
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2001, 01, 01) and C.condition_start_date <= DATEFROMPARTS(2019, 12, 31))
AND YEAR(C.condition_start_date) - P.year_of_birth >= 18
...
WHERE C.drug_exposure_start_date >= DATEFROMPARTS(2001, 01, 01)

...
FROM (
	...
	FROM @target_database_schema.@target_cohort_table e
	  ...
	  JOIN @target_database_schema.@target_cohort_table t ON t.cohort_start_date <= e.cohort_start_date AND e.cohort_start_date <= t.cohort_end_date AND t.subject_id = e.subject_id
...
TRUNCATE TABLE #nonRepetitiveEvents;
DROP TABLE #nonRepetitiveEvents;
